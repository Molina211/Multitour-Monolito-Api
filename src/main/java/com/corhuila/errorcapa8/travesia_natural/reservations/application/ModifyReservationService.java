...
public class ModifyReservationService implements ModifyReservationUseCase {
    ...
    public ModifyReservationService(TenantRepositoryPort tenantRepositoryPort,
    ...
    public Reservation modifyReservation(ModifyReservationCommand command) {
        ...
        Reservation modified = reservation.modify(command.reservedServices(), command.projectedValue(),
                command.finalValue(), command.reason(), command.actorId());

        return reservationRepositoryPort.save(modified);
    }
