...
@Service
public class AuthorizeRefundService implements AuthorizeRefundUseCase {

    private final TenantRepositoryPort tenantRepositoryPort;
    private final MembershipRepositoryPort membershipRepositoryPort;
    private final ReservationRepositoryPort reservationRepositoryPort;

    public AuthorizeRefundService(TenantRepositoryPort tenantRepositoryPort,
    ...
    @Override
    public Reservation authorizeRefund(AuthorizeRefundCommand command) {
        ...
        Reservation authorized = reservation.authorizeRefund(command.actorId(), command.note());

        return reservationRepositoryPort.save(authorized);
    }
